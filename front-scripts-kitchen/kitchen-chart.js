...
const fetchData = async () => {
    try {
        const { data } = await axios.get('https://app-beiu.herokuapp.com/api/v1/kitchen/get/all', {
        headers: {
    ...
    function drawChart() {
        ...
        var options = {'title':'Bucati vandute',
                    ...
                    'height': 60 * length,
                    'colors': colors,
                    chartArea:{left:300, top:70, width: 67 * length},
                    bar: {groupWidth: "75%"},
        ...
        var chart = new google.visualization.BarChart(document.getElementById('first-chart'));
        chart.draw(data, options);
        var chart2 = new google.visualization.BarChart(document.getElementById('second-chart'));
